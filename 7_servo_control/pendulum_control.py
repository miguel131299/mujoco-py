...
cam.azimuth = -90.88203125000005 ; cam.elevation = -1.7296874999999972 ; cam.distance =  7.718057392438703
cam.lookat =np.array([ -0.03893422613288128 , 0.0001766818442830563 , 1.3371744345301313 ])
data.qpos[0] = np.pi/2

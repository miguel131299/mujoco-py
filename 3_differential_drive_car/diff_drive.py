...
def controller(model, data):
    ...
    data.ctrl[0] = 10 #left wheel velocity
    data.ctrl[1] = 2 #right wheel velocity
...
cam.azimuth = 89.50703125 ; cam.elevation = -49.435156250000006 ; cam.distance =  14.14010744305032
